...
* 2016 – 2017 – Full-Stack Software Engineer at jooraccess.com (Django, PostgreSQL, AngularJS, Dojo, CORS, JWT, Django-rest-framework, CakePHP, Pl/SQL, Scrum). Introduced TDD (and some others practices of XP), DDD, Designing Through Refactorin, code review based on catalogs of refactorings and on catalogs of code smells. Solved a lot of issues of Architecture and Design. Improved quality of the codebase. Reduced time of implementation new features due to the introduced design approaches. Created the `high-level tool to handle data <https://github.com/emacsway/store>`__ on client-side.
