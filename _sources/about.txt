...
Python/FullStack Software Engineer, XP coach, Solution Architect, Delivery Manager
...
..
    ...
    * Jul 2017 - present - Solution Architect, XP coach and Delivery Manager at Business Technologies www.biz-tek.ru. Introduced best practices of Software Design and Agile software development (TDD, XP, CI, CD, DDD, SOA, Designing Through Refactoring etc.). Keeping the flattened change cost curve of the project. Clean architecture and rapid development. Quick MVP creation. Technology stack and approaches: Python, JavaScript, PostgreSQL, RESTful API, Django, Django-rest-framework, Angular5+, AWS, Heroku, Scrum, Jira etc.
