...
.. _de-cqrs-command-and-result-ru:
...
Впрочем, вопрос относительно того, должна ли Команда CQRS возвращать результат, и не противоречит ли это CQS принципу Bertrand Meyer, заслуживает на ":doc:`отдельное исследование <./cqrs-command-and-result>`".
