...
И хотя это обычно никак не усложняет тестирование (потому что дескрипторы способны кэшировать в памяти явно установленные клиентом объекты), но все-таки привносит служебную логику доступа к данным в Domain Model, пусть она и хорошо инкапсулирована за интерфейсом дескриптора.
