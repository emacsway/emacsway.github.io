...
Если Вы вынуждены изменять реализацию Domain Model, то это значит, что Ваша программа не имеет независимости от IO-устройства, и это нарушает Single Responsibility Principle (что выражается в виде Code Smell "Shotgun Surgery").
