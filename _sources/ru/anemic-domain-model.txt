...
К сожалению, в списке литературы статьи отсуствует книга "Clean Code" by Robert C. Martin, в которой рассказывается, как для разделения служебной логики и бизнес-логики вот уже более 10 лет используется :ref:`Cross-Cutting Concerns <domain-model-relationship-implementing-aop-ru>`.
...
Написание несопровождаемого Spaghetti-code требует наименьших умственных усилий.
