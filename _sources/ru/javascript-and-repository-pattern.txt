...
В некоторых проектах я встречал внедрение зависимостей посредством использования замыкания фабрики класса Доменной Модели, а не экземпляра Доменной Модели.
