...
Agile - это значит достигнуть такого качества архитектуры (проектирования), которое позволит дешево внедрять проектные решения не заблаговременно, а итеративно, уже в процессе разработки и развития продукта, с учетом обратной связи от практического использования продукта.
...
К сожалению, из Scrum удалили именно то, что поддерживает стоимости изменения программы низкой и делает Agile возможным.
...
Причины возникновения Agile
===========================

Возникновение Agile обусловлено стечением ряда факторов.
...
В-четвертых, автоматизированное тестирование вошло в новую фазу своего развития.
...
Актуальность этого нашла отражение в скоротечности изменения рыночных требований, когда программы стали морально устаревать быстрее, чем разрабатываться.
...
Здесь я должен сделать оговорку, что Agile позволяет изменить модель проектирования, но не исключить проектирование.
Именно в этом и заключается основная ошибка многих менеджеров, которые не понимают что Agile становится возможным именно в результате качественных проектных решений, позволяющих сохранять низкой стоимость изменения программы.
