...
Agile - это значит достигнуть такого качества архитектуры, которое позволит дешево внедрять проектные решения не заблаговременно, а итеративно, уже в процессе разработки и развития продукта, с учетем обратной связи от практического использования продукта.
