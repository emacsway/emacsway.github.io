...
Во-первых, обрели популярность объектно-ориентированные языки, предоставляющие более высокие возможности к управлению сложностью кода.
...
Это был первый серьезный удар по стоимости изменения кода.
...
Это был второй удар по стоимости изменения кода.
...
Накопление этих факторов привело к тому, что проектные решения стало возможным изменять настолько дешево, что необходимость в заблаговременном проектировании отпала.
Количественные изменения перешли в качественные.
Это нашло отражение в скоротечности изменений рыночных требований, когда программы устаревали морально быстрее, чем разрабатывались.

Эти обстоятельства позволили переосмыслить модель проектирования и планирования разработки программного продукта.
