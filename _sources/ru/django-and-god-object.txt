...
Следующая проблема имеет название "Божественный Объект" ("`God Object <https://en.wikipedia.org/wiki/God_object>`__ или  "`God Class <http://wiki.c2.com/?GodClass>`__").
...
А инкапсуляция создана для защиты абстракции, которая, в свою очередь, создана для укрощения сложности.
