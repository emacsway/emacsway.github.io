...
Один из частых вопросов, который я слышу регулярно, - это "посоветуйте список литературы в области разработки программного обеспечения".
...
Классическая ошибка новичков - жажда к знаниям.
Обычно это приводит к тому, что они надрываются, впадают в депрессию, и прекращают развиваться.
Решается эта проблема очень просто - жажда должна быть не к знаниям, а к дисциплине.
А уж дисциплина обязательно приведет к знаниям.
Дисциплина - это, своего рода, производная знаний.
Нужно сперва выработать привычку, а затем привычка будет работать на вас.
...
И желательно, чтобы читаемая книга совпадала с темой текущего проекта, чтобы через практику хорошо легла в память.
Я по этой причине часто изменял свой график чтения.
Обычно я в параллели читаю 2-3 книги. Одну - планово, другие - по потребностям проекта.

Хорошая вещь для систематизации собственных знаний - это написание статей и участие в профессиональных дискуссиях.
...
К тому же, это хорошо вырабатывает сдержанность.
...
Без знаний, изложенных в этой книге, вы просто не сможете изыскать время на самообучение, и список остальных книг вам просто не понадобится:
...
Существует книга, которая за 160 страниц может дать эти базовые основы в легкой и популярной форме:
