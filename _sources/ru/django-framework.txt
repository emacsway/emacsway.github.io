...
Честно сказать, Django REST framework заставляет изрядно посидеть в отладчике, и потратить на него определенное время, что, разумеется, характеризует проектные решения не с лучшей стороны.
