...
Благодаря Сервис-ориентированной архитектуре (SOA) в проекте крайне-низкий уровень внутренних зависимостей, что позволяет, безболезненно перенести один из компонентов системы (например, контент) на принципиально иной вид хранилища данных (например, MongoDB).
